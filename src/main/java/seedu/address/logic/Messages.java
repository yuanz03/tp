...
public class Messages {
    ...
    public static final String MESSAGE_NO_PLAYERS_IN_TEAM = "No players assigned to a team matching: \"%1$s.\"";
    ...
    public static final String MESSAGE_NO_MATCHING_TEAM_INJURY_AND_POSITION =
            ...
            + " have an injury matching: %2$s and position \"%3$s\".";
    ...
    public static final String MESSAGE_NO_MATCHING_TEAM_AND_POSITION =
            "No players matching a team matching: \"%1$s\" and position \"%2$s\".";
    public static final String MESSAGE_NO_MATCHING_INJURY_AND_POSITION =
            "No players with an injury matching: \"%1$s\" and position \"%2$s\".";
