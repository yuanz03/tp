    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_PLAYER, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL,
                        PREFIX_ADDRESS, PREFIX_TEAM, PREFIX_INJURY, PREFIX_TAG);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_PLAYER, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL,
                PREFIX_ADDRESS, PREFIX_TEAM, PREFIX_INJURY);
        ...
        if (argMultimap.getValue(PREFIX_INJURY).isPresent()) {
            editPersonDescriptor.setInjury(ParserUtil.parseInjury(argMultimap.getValue(PREFIX_INJURY).get()));
        }
